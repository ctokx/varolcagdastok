...
Solve for $w$:
```
$$w = \begin{bmatrix} 7/3 & -1 \\ -1 & 1/2 \end{bmatrix} \begin{bmatrix} 11 \\ 25 \end{bmatrix} = \begin{bmatrix} (7/3)(11) - 25 \\ -11 + 25/2 \end{bmatrix} = \begin{bmatrix} 77/3 - 75/3 \\ -22/2 + 25/2 \end{bmatrix} = \begin{bmatrix} 2/3 \\ 3/2 \end{bmatrix}$$
...
The prediction $\hat{y} = Xw$ is the orthogonal projection of $y$ onto the column space of $X$.
